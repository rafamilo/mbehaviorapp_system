...
class PhoneTypesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('PhoneTypes') ? [] : ['className' => PhoneTypesTable::class];
        $this->PhoneTypes = TableRegistry::getTableLocator()->get('PhoneTypes', $config);
    }
