...
/**
 * BillsToReceiveFixture
 *
 */
class BillsToReceiveFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'bills_to_receive_invoice_plan_id' => ['type' => 'index', 'columns' => ['invoice_plan_id'], 'length' => []],
            'bills_to_receive_created_by' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
            'bills_to_receive_updated_by' => ['type' => 'index', 'columns' => ['updated_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'bills_to_receive_created_by' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'bills_to_receive_invoice_plan_id' => ['type' => 'foreign', 'columns' => ['invoice_plan_id'], 'references' => ['invoice_plans', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'bills_to_receive_updated_by' => ['type' => 'foreign', 'columns' => ['updated_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
            [
                ...
                'invoice_plan_id' => 1,
                'value' => 1.5,
                'issue_date' => '2018-12-18 14:41:32',
                'expiration_date' => '2018-12-18 14:41:32',
                'reference_date' => '2018-12-18 14:41:32',
                'payment_status' => 1,
                'created' => '2018-12-18 14:41:32',
                'updated' => '2018-12-18 14:41:32',
                'created_by' => 1,
                'updated_by' => 1,
                'status' => 1
            ],
