            ...
            <div class="card">
                <div id="users" class="form card-body">
                    ...
                    <div class="col-12 no-padding row">
                                                ...
                                                <div class='col-6'>
                            <?php                                         echo $this->Form->input('birthdate', ['type' => 'text', 'class' => 'datepicker form-control','value'=>$this->Time->format($user->birthdate,'dd/MM/Y H:m'), 'append' => [$this->Form->button("<i class='fa fa-calendar no-margin'></i>", ['type'=>'button', 'class'=>'background-append'])]]);
                                                 ?>
                        </div>
                                                <div class='col-6'>
