        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <strong>
                                                <?= __('Editar Lodger Apartment Invoice') ?>
                                            </strong>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div id="lodgerApartmentInvoices" class="form card-body">
                    ...
                    <div class="col-12 no-padding row">
                                                    <div class='col-6'>
                                                        <?=$this->Form->input('lodger_apartment_id', ['data'=>'select','controller'=>'lodgerApartments','action'=>'fill','data-value'=>$lodgerApartmentInvoice->lodger_apartment_id, 'class'=>'form-control']); ?>
                                                    </div>
                                                <div class='col-6'>
