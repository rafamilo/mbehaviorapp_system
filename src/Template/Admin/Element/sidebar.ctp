  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#general-pages" aria-expanded="false" aria-controls="general-pages">
        <img class="menu-icon" src="/img/menu_icons/01.png" alt="menu icon"> <span class="menu-title">Blocos</span><i
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#appartments" aria-expanded="false" aria-controls="appartments">
        <img class="menu-icon" src="/img/menu_icons/01.png" alt="menu icon"> <span class="menu-title">Apartamentos</span><i
          class="menu-arrow"></i></a>
