<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
    <a class="navbar-brand brand-logo" href="/">
      <h4 style="color: black; margin-top: 15px">Pesquisa Goulart</h4>
      <!-- <?= $this->Html->image('home/livinglab-logo-nome.png')?>-->
    </a>
    <a class="navbar-brand brand-logo-mini" href="/">
      <h4 style="color: black; margin-top: 15px">NdC</h4>
      <!-- <?= $this->Html->image('home/livinglab-logo.png')?> -->
    </a>
  </div>
    ...
    <ul class="navbar-nav navbar-nav-right">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
                <?= $this->Html->image('faces/face4.jpg')?>
            </div>
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
                <?= $this->Html->image('faces/face6.jpg')?>
            </div>
            <div class="preview-item-content">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <?= $this->Html->image('faces/face2.jpg')?>
            </div>
            <div class="preview-item-content flex-grow">
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <?= $this->Html->image('faces/face3.jpg')?>
            </div>
            <div class="preview-item-content flex-grow">
