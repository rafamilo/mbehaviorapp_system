    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h2>Prêmios</h2>
                    <strong><?= __('Editar Prêmio') ?></strong>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div id="awards" class="form card-body">
                    ...
                    <div class="col-12 no-padding row">
                        ...
                        <div class='col-6'>
                            <?= $this->Form->input('sort_date', ['label' => 'Data do sorteio', 'type' => 'text', 'class' => 'datepicker form-control', 'mask' => 'date', 'value' => date_format($award->sort_date, 'd/m/Y'), 'append' => [$this->Form->button("<i class='fa fa-calendar no-margin'></i>", ['type' => 'button', 'class' => 'background-append'])]]); ?>
                        </div>
                        <div class='col-6'>
