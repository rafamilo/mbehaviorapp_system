        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div id="invoicePlans" class="form card-body">
                    <?= $this->Form->create($invoicePlan) ?>
                    <div class="col-12 no-padding row">
                                                    <div class='col-6'>
                                                        <?=$this->Form->input('name', ['class'=>'form-control']); ?>
                                                    </div>
                                                <div class='col-6'>
                                                        <?=$this->Form->input('entry_type_id', ['data'=>'select','controller'=>'entryTypes','action'=>'fill','data-value'=>$invoicePlan->entry_type_id, 'class'=>'form-control']); ?>
                                                    </div>
                                                <div class='col-6'>
