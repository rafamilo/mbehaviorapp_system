                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= h($blockInvoices->block_id) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->invoice_plan_id) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->value) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->issue_date) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->expiration_date) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->reference_date) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->payment_status) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->created) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->updated) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->created_by) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->updated_by) ?>
                                    </td>
                                    <td>
                                        <?= h($blockInvoices->status) ?>
                                    </td>
                                    <td class="actions">
