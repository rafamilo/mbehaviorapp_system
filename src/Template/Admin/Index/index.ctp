<div class="content-wrapper">
                ...
                <div class="card-body">
                    ...
                    <div class="fluid-container">
                        <div class="row ticket-card mt-3 pb-2 border-bottom">
                            <div class="col-1">
                                <?= $this->Html->image('faces/face1.jpg', ['class' => 'img-sm rounded-circle'])?>
                            </div>
                        ...
                        <div class="row ticket-card mt-3 pb-2 border-bottom">
                            <div class="col-1">
                                <?= $this->Html->image('faces/face2.jpg', ['class' => 'img-sm rounded-circle'])?>
                            </div>
                            <div class="ticket-details col-9">
                                <div class="d-flex">
                                    <p class="text-primary font-weight-bold mr-2 mb-0 no-wrap">Mariane :</p>
                                    <p class="font-weight-medium mr-1 mb-0">[#4]</p>
                                    <p class="font-weight-bold mb-0 ellipsis">Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Quasi
                                        amet totam, dignissimos fugiat voluptates, ab magni, necessitatibus excepturi
                                        inventore, mollitia ipsa
                                        quaerat aliquam.</p>
                                </div>
                                <p class="text-small text-gray">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit. Recusandae animi
                                    omnis, a?</p>
                                <div class="row text-muted d-flex">
                                    <div class="col-12 d-flex">
                                        <p class="mb-0 mr-2">data:</p>
                        ...
                        <div class="row ticket-card mt-3 pb-2 border-bottom">
                            <div class="col-1">
                                <?= $this->Html->image('faces/face3.jpg', ['class' => 'img-sm rounded-circle'])?>
                            </div>
                            <div class="ticket-details col-9">
                                <div class="d-flex">
                        ...
                        <div class="row ticket-card mt-3 pb-2 border-bottom">
                            <div class="col-1">
                                <?= $this->Html->image('faces/face4.jpg', ['class' => 'img-sm rounded-circle'])?>
                            </div>
                            <div class="ticket-details col-9">
                                <div class="d-flex">
                        ...
                        <div class="row ticket-card mt-3 pb-2">
                            <div class="col-1">
                                <?= $this->Html->image('faces/face5.jpg', ['class' => 'img-sm rounded-circle'])?>
                            </div>
                            <div class="ticket-details col-9">
                                <div class="d-flex">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h4 class="card-title font-weight-bold text-right mb-0">R$ 65.430,87</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h4 class="card-title font-weight-bold text-right mb-0">127</h4>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h4 class="card-title font-weight-bold text-right mb-0">40</h4>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right">
                            ...
                            <div class="fluid-container">
                                <h4 class="card-title font-weight-bold text-right mb-0">8</h4>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted mt-3">
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-4">Gráfico de contas</h5>
