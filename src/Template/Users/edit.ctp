        ...
        <div id="users" class="form">
            ...
            <fieldset>
                    ...
                    <?= __('Editar User') ?>
                                ...
                                <div class='col-md-6'>
                    <?php                                     echo $this->Form->input('birthdate', ['type' => 'text', 'class' => 'datetimepicker form-control','value'=>$this->Time->format($user->birthdate,'dd/MM/Y H:m'), 'append' => [$this->Form->button("<i class='fa fa-calendar'></i>"), ['type' => 'button'])]]);
                                             ?>
                </div>
                                <div class='col-md-6'>
