...
use App\Model\Entity\BillsToReceive;
...
class BillsToReceiveTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('bills_to_receive');
    ...
    {
        $queryData->where(['BillsToReceive.status !=' => 0]);
        return $queryData;
    }
}